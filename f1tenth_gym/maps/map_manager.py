...
## train dict
TRAIN_MAP_DICT = {
    0: 'Austin', 1: 'Budapest', 2: 'Hockenheim', 3: 'Melbourne', 4: 'MexicoCity',
    5: 'MoscowRaceway', 6: 'Nuerburgring', 7: 'Oschersleben', 8: 'Sakhir',
    9: 'Sepang', 10: 'Silverstone', 11: 'Sochi', 12: 'Spa', 13: 'Spielberg',
    14: 'YasMarina'
}

TEST_MAPS_DICT = {
    0: 'BrandsHatch', 1: 'Catalunya', 2: 'IMS', 3: 'Monza', 4: 'SaoPaulo',
    5: 'Zandvoort'
}
